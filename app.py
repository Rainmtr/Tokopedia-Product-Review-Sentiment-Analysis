...
# Helper functions here (roundUp, extract_shopDomain_productKey, getReviewData, getReviews, analyze_sentiment)
...
def home():
    if request.method == 'POST':
        ...
        try:
            ...
            return render_template('home.html', stats=stats, showModal=True)
        except Exception as e:
            return str(e)

    return render_template('home.html', stats=None, showModal=False)
